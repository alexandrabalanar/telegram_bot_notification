...
namespace revcom_bot
{
    class DBConnect : Form1
    {
        ...
        public void Insert(String FirstName, String LastName, String ChatID, String Task, String Level, DateTime Time)
        {
            string query = "INSERT INTO users (id, FirstName, LastName, ChatID, Task, Level, Time, Time2) VALUES(null, '"+ FirstName +"', '"+ LastName +"','"+ ChatID +"','"+Task+"','"+Level+"','"+Time+"','0')";
        ...
        {
            string query = "UPDATE users SET Time2='"+DateTime.Now+ "' WHERE chatID='252138799' AND Task = '"+name+"'";
